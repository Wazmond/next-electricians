...
const ReviewCard = (props: Props) => {
  return (
    <div className={`flex flex-col rounded-lg md:w-1/4 px-4 py-4 gap-4 shadow-2xl`}>
      <div className={`flex flex-row gap-4`}>
        {props.profile ? (
          ...
          // <div className='bg-mono-500 h-8 w-8 justify-center items-center'>
            <p className={`flex bg-mono-500 text-white h-10 w-10 text-center items-center justify-center rounded-full leading-normal`}>{props.name[0]}</p>
          // </div>
        )}
