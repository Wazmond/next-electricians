...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE IF NOT EXISTS "featured_featured_images" (
  ...
  DO $$ BEGIN
   ALTER TABLE "featured_featured_images" ADD CONSTRAINT "featured_featured_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "featured_featured_images" ADD CONSTRAINT "featured_featured_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."featured"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_featured_fk" FOREIGN KEY ("featured_id") REFERENCES "public"."featured"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "featured_featured_images_order_idx" ON "featured_featured_images" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "featured_featured_images_parent_id_idx" ON "featured_featured_images" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "featured_featured_images_image_idx" ON "featured_featured_images" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "featured_updated_at_idx" ON "featured" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "featured_created_at_idx" ON "featured" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_featured_id_idx" ON "payload_locked_documents_rels" USING btree ("featured_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "featured_featured_images" CASCADE;
  DROP TABLE "featured" CASCADE;
